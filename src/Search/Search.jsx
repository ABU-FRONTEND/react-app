      ...
      return(
            <div className="search_content">
               ...
               <div className="dropdown">
                  <div className="dropdown_header" onClick={active === false ? this.show : this.hide}>
                  {ul ? ul : 'Filter by Region'}
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none">
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M8.45 0.450001L5 3.9L1.55 0.450001L0.5 1.5L5 6L9.5 1.5L8.45 0.450001Z" fill="white" />
                  </svg>
                  </div>
